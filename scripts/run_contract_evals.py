...
REQUIRED_EXPECTATIONS: dict[str, dict[str, Any]] = {
    ...
    "serious_mode": {
        "serious_tone": True,
        "serious_need_addressed": True,
        "tease_or_flirt": False,
        "play_suppressed": True,
        "topic_shift_suppressed": True,
        "primary_action_forced": False,
    ...
    "continuation_low_investment": {
        ...
        "new_hook_not_forced": True,
        "primary_action_forced": False,
    },
    "continuation_partner_opens": {
        "natural_continuation_allowed": True,
    ...
    "concise_style_consistency": {
        ...
        "current_style_first": True,
        "one_small_stretch": True,
        "large_persona_jump": False,
    },
    "expression_level_contextual": {
        "expression_level_contextual": True,
        "stage_to_e_direct_mapping": False,
        "trend_to_e_direct_mapping": False,
        "serious_boundary_constraints_apply": True,
        "growth_target_overridden_by_safety": True,
    },
    "actual_send_style_learning": {
        "learn_from_actual_send": True,
        "assistant_draft_not_treated_as_user_style": True,
        "copy_rate_not_success_metric": True,
        "partner_outcome_not_sole_metric": True,
        "stable_profile_update_requires_confirmation": True,
    },
    "user_draft_minimal_edit": {
        "preserve_user_draft": True,
    ...
    "interview_mode_decision": {
        "ask_suppressed": True,
        "forced_question": False,
        "non_question_action_allowed": True,
        "play_mechanically_blocked": False,
        "replacement_action_forced": False,
    },
